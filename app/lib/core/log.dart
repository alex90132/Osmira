...
/// filter on the `Osmira` marker to isolate them. In release every call
/// short-circuits *before* building the message, so there is zero string work
/// and nothing is ever emitted or dispatched.
